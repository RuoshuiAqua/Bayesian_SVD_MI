...
write.table(omega, file=paste("./output/omega/omega_mcar", "_df_", df, "_m_", m, "_n_", n, "_K_", K, ".csv", sep = ""), row.names = FALSE, sep=",", col.names = FALSE)

M = read.csv(paste("./output/simulated_data/M",  "_df_", df, "_m_", m, "_n_", n, "_K_", K, ".csv", sep = ""), header = FALSE)
omega = f.omega.mar(Y=M, prob=0.15, method="sv")
write.table(omega, file=paste("./output/omega/omega_sv", "_df_", df, "_m_", m, "_n_", n, "_K_", K, ".csv", sep = ""), row.names = FALSE, sep=",", col.names = FALSE)

omega = f.omega.mar(Y=M, prob=0.15, method="corr")
write.table(omega, file=paste("./output/omega/omega_corr",  "_df_", df, "_m_", m, "_n_", n, "_K_", K, ".csv", sep = ""), row.names = FALSE, sep=",", col.names = FALSE)
