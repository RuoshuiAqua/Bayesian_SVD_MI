...
f.omega.mar = function(Y, prob=0.2, beta = 1.0, method){
...
write.table(omega, file=paste("./output/omega/omega_mcar", "_m_", m, "_n_", n, "_K_", K, "_beta_", beta, ".csv", sep = ""), row.names = FALSE, sep=",", col.names = FALSE)

M = read.csv(paste("./output/simulated_data/M", "_m_", m, "_n_", n, "_K_", K, ".csv", sep = ""), header = FALSE)
omega = f.omega.mar(Y=M, prob=0.15, beta = beta, method="sv")
write.table(omega, file=paste("./output/omega/omega_sv", "_m_", m, "_n_", n, "_K_", K, "_beta_", beta, ".csv", sep = ""), row.names = FALSE, sep=",", col.names = FALSE)

omega = f.omega.mar(Y=M, prob=0.15, beta = beta, method="corr")
write.table(omega, file=paste("./output/omega/omega_corr", "_m_", m, "_n_", n, "_K_", K, "_beta_", beta, ".csv", sep = ""), row.names = FALSE, sep=",", col.names = FALSE)
